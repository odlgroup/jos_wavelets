...
BOOST_PYTHON_MODULE(jos_wavelets) {
    // 1D
    def("wavelet_transform1D", wavelet_transform1DPy);
    def("invwavelet_transform1D", invwavelet_transform1DPy);
    def("adjointinvwavelet_transform1D", adjointinvwavelet_transform1DPy);      def("adjointwavelet_transform1D", adjointwavelet_transform1DPy);
    // 2D
